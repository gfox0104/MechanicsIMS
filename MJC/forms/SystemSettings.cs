...
namespace MJC.forms
{
    public partial class SystemSettings : GlobalLayout
    {
        ...
        private void GetSettings()
        {
            ...
            PrintOptions.GetComboBox().Text = Session.SettingsModelObj.Settings.printOption;
        ...
        private bool SaveSettings()
        {
            ...
            try
            {
                Session.SettingsModelObj.SaveSetting(selectedTaxCode.id, businessName, description, address1, address2, city, state, zipCode, phone, fax, ein, training, targetPrinter, authorizationCode, refreshToken, footerText, termsOfService);
            }
